...
\chapter{🎌 \ruby{自己紹介}{じこしょうかい} — Presentaciones}
...
\midrule
\kanjirow{名}{めい}{な}{nombre}{\ruby{名前}{なまえ} / \ruby{有名}{ゆうめい}}
\kanjirow{前}{ぜん}{まえ}{frente / antes}{\ruby{名前}{なまえ} / \ruby{午前}{ごぜん}}
\kanjirow{学}{がく}{まな}{estudiar}{\ruby{学生}{がくせい} / \ruby{大学}{だいがく}}
\kanjirow{生}{せい}{い・う}{vida / nacer}{\ruby{学生}{がくせい} / \ruby{先生}{せんせい}}
\kanjirow{先}{せん}{さき}{antes / punta}{\ruby{先生}{せんせい} / \ruby{先月}{せんげつ}}
\bottomrule
\end{tabularx}
\end{tcolorbox}
