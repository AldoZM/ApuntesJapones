% unidades/02-numeros-tiempo.tex
\chapter{🔢 \ruby{数字}{すうじ}と\ruby{時間}{じかん} — Números y Tiempo}
...
\begin{enumerate}
  ...
  \item ¿Qué significan 月曜日 y 日曜日?
\end{enumerate}
\vspace{0.4em}
\textbf{Respuestas:}
1) \ruby{午後}{ごご}\ruby{八時}{はちじ}\ruby{四十五分}{よんじゅうごふん}です。\quad
2) (personal: Ej. \ruby{十月}{じゅうがつ}\ruby{五日}{いつか}です)\quad
3) Lunes y Domingo.
\end{tcolorbox}
...
\midrule
\kanjirow{時}{じ}{とき}{tiempo / hora}{\ruby{時間}{じかん} / \ruby{時}{とき}どき}
\kanjirow{分}{ぶん・ぷん}{わ}{minuto / dividir}{\ruby{五分}{ごふん} / \ruby{分}{わ}かる}
\kanjirow{年}{ねん}{とし}{año}{\ruby{今年}{ことし} / \ruby{来年}{らいねん}}
\kanjirow{月}{げつ・がつ}{つき}{mes / luna}{\ruby{一月}{いちがつ} / \ruby{今月}{こんげつ}}
\kanjirow{日}{にち・じつ}{ひ・か}{día / sol}{\ruby{今日}{きょう} / \ruby{毎日}{まいにち}}
\kanjirow{今}{こん}{いま}{ahora}{\ruby{今週}{こんしゅう} / \ruby{今}{いま}}
\bottomrule
\end{tabularx}
\end{tcolorbox}
