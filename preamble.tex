...
% === Emoji fallback: Unicode inline emojis → Segoe UI Emoji ===
\directlua{
...
\setmainjfont{Yu Gothic}[BoldFont=Yu Gothic Bold, ItalicFont=Yu Gothic, BoldItalicFont=Yu Gothic Bold, RawFeature={fallback=emojifb}]
\setsansjfont{Yu Gothic}[RawFeature={fallback=emojifb}]

% === Fuentes latinas ===
\setmainfont{Georgia}[RawFeature={fallback=emojifb}]
\setsansfont{Calibri}[RawFeature={fallback=emojifb}]
