...
\vocabitem{乗り換える}{乗り換える}{hacer transbordo}{v. gr.2}
...
\patron{Subir / Bajar transporte: に乗る / を降りる}
  ...
  \ej{\ruby{渋谷}{しぶyあ}で\ruby{降}{お}りてください。}
    {Baje en Shibuya.}}
...
2) (personal)\quad
3) Por favor, haga transbordo en la siguiente estación.
\end{tcolorbox}
...
\midrule
\kanjirow{車}{しゃ}{くるま}{coche / rueda}{\ruby{電車}{でんしゃ} / \ruby{自転車}{じてんしゃ}}
\kanjirow{転}{てん}{ころ}{rodar}{\ruby{自転車}{じてんしゃ} / \ruby{運転}{うんてん}}
\kanjirow{自}{じ}{みずか}{uno mismo}{\ruby{自転車}{じてんしゃ} / \ruby{自分}{じぶん}}
\kanjirow{乗}{じょう}{の}{subir / montar}{\ruby{乗}{の}る / \ruby{乗客}{じょうきゃく}}
\kanjirow{降}{こう}{お・ふ}{bajar / caer}{\ruby{降}{お}りる / \ruby{降}{ふ}る}
\bottomrule
\end{tabularx}
\end{tcolorbox}
