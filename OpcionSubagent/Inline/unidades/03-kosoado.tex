...
\begin{enumerate}
  \item ¿Cómo dices "Esta pluma es mía"? (pluma = ペン)
  \item Pregunta "¿Qué es aquello de allá?".
  \item Traduce: \ruby{誰}{だれ}のかばんですか。
\end{enumerate}
\vspace{0.4em}
\textbf{Respuestas:}
1) このペンは\ruby{私}{わたし}のです。\quad
2) あれは\ruby{何}{なん}ですか？\quad
3) ¿De quién es la bolsa?
\end{tcolorbox}
...
\midrule
\kanjirow{何}{か}{なに・なん}{qué}{\ruby{何}{なに} / \ruby{何時}{なんじ}}
\kanjirow{誰}{すい}{だれ}{quién}{\ruby{誰}{だれ} / \ruby{誰}{だれ}か}
\kanjirow{物}{ぶつ・もつ}{もの}{cosa}{\ruby{食べ物}{たべもの} / \ruby{飲み物}{のみもの}}
\bottomrule
\end{tabularx}
\end{tcolorbox}
