...
\newcommand{\comparacion}[4]{%
  \begin{tcolorbox}[comparacionbox, title={⚖ #1}]
  \noindent\begin{minipage}[t]{0.47\linewidth}
    \textcolor{jpnavy}{\textbf{#2}}
  \end{minipage}\hfill\begin{minipage}[t]{0.47\linewidth}
    \textcolor{jpgreen}{\textbf{#3}}
  \end{minipage}\par
  \vspace{0.4em}\small #4
  \end{tcolorbox}\vspace{0.2em}}

\newcommand{\coloquial}[3]{%
  \begin{tcolorbox}[coloquialbox, title={\emoji{speech-balloon} Forma Coloquial}]
  \noindent\textbf{Formal:} #1\par\smallskip
  \noindent\textbf{Coloquial:} \textbf{#2}\par\smallskip
  \noindent\textbf{Nota:} {\small\itshape #3}
  \end{tcolorbox}\vspace{0.2em}}

\newcommand{\culturabox}[2]{%
  \begin{tcolorbox}[culturaboxstyle, title={⛩ #1}]
  #2
  \end{tcolorbox}\vspace{0.2em}}
